...
const Footer = () => {
  ...
  return (
    <footer id="contact-us" className="bg-foreground text-white py-20">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed font-sans">
        ...
        <div className="border-t border-gray-800 pt-12 mt-12">
            ...
            >
              {navItems.map((item, index) => (
                <motion.a
                  ...
                  whileHover={{ y: -2 }}
                  className="text-gray-400 hover:text-white transition-colors text-lg font-sans"
                >
                  {item}
                </motion.a>
              ))}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-center mt-16 pt-8 border-t border-gray-800 text-gray-400 text-lg font-sans"
          >
            <p>© Area. 2025</p>
